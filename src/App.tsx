                          ...
                          >
                            ...
                            <div className="w-1/2 p-2.5 flex flex-col justify-between items-end text-right">
                              <div className="flex items-center gap-1.5 h-[14px] select-none">
                                <div className={`w-2 h-2 rounded-full ${socketConnected ? 'bg-[#4c0f12] shadow-[0_0_8px_rgba(76,15,18,0.4)]' : 'bg-[#e23f3f] shadow-[0_0_8px_rgba(226,63,63,0.6)] animate-pulse'}`} />
